...
//            'throttle:60,1',
    ...
    protected $routeMiddleware = [
        ...
        'validateUserToken' => \App\Http\Middleware\ValidateUserToken::class,
        'validatePublicApp' => \App\Http\Middleware\ValidatePublicApp::class,
    ];
    ...
    protected $middlewarePriority = [
		...
		\App\Http\Middleware\ValidatePublicApp::class,
